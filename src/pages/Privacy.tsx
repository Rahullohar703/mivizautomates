        ...
        <div className="section-container max-w-4xl">
          ...
          <div className="space-y-8 text-muted-foreground">
            <section>
              ...
              <p className="mb-4">
                Welcome to Mivizhub. We respect your privacy and are committed to protecting your personal data. 
            ...
            <section>
              ...
              <p className="mb-4">
                If you have any questions about this privacy policy or our privacy practices, please contact us via the forms on our website or directly at our provided contact methods.
              </p>
            </section>
          </div>
        </div>
