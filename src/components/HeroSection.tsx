...
const HeroSection = () => (
  <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
    ...
    {/* Floating orbs */}
    <FloatingOrb className="top-1/4 -left-20 w-[500px] h-[500px] bg-primary/20" delay={0} />
    <FloatingOrb className="bottom-1/4 -right-20 w-[600px] h-[600px] bg-cyan/10" delay={2} />
    <FloatingOrb className="top-1/2 left-1/2 -translate-x-1/2 w-[400px] h-[400px] bg-violet-glow/10" delay={4} />
    ...
    <div className="section-container relative z-10 pt-32 pb-20 md:pt-40 md:pb-32">
      <div className="max-w-5xl mx-auto text-center">
        ...
        <motion.p
          ...
          className="text-body max-w-[600px] mx-auto mb-12"
        >
        ...
        >
          {[
            ...
            >
              <div className="text-2xl md:text-3xl font-bold text-gradient mb-1">{item.stat}</div>
